  ...
  return (
    <Dropdown>
      ...
      <Menu slots={{ listbox: Listbox }}>
        <MenuItem onClick={() => createHandleMenuClick('Rating(high-low)')}> Rating(high-low)</MenuItem>
        <MenuItem onClick={() => createHandleMenuClick('Price(high-low)')}>
         Price(high-low)
        </MenuItem>
        <MenuItem onClick={() => createHandleMenuClick('Price(low-high)')}>Price(low-high)</MenuItem>
      </Menu>
    </Dropdown>
  );
}
